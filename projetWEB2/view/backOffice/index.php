...
<div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- Bouton "Ajouter Transport" qui redirige vers add.php -->
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="action-btns">
                                                <a href="../transport/edit.php?matricule=<?= $t->getMatricule(); ?>" class="btn btn-edit">Modifier</a>
                                                <a href="../transport/delete.php?matricule=<?= $t->getMatricule(); ?>" class="btn btn-delete" onclick="return confirm('Confirmer la suppression ?')">Supprimer</a>
