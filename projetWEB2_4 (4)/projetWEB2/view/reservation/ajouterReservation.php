...
require_once '../../model/Transport.php';
 // This loads the Composer autoloader
...
<?php
if ($success) {
    // Ensure $reservationId holds the correct ID value
    echo "<script>
        if (confirm('✅ Réservation effectuée avec succès ! Voulez-vous effectuer le paiement maintenant ?')) {
            // Ensure the URL has the correct reservation ID
           // Correct URL with reservation ID passed
window.location.href = 'formPaiment.php?id_r=' + reservationId;'
